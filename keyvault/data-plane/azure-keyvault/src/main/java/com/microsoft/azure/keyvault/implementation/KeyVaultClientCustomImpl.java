...
//        service = RestProxy.create(KeyVaultClientService.class, httpPipeline());
//    }
////
////    @Override
...
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient createKey" })
//        @POST("keys/{key-name}/create")
//        Observable<Response<ResponseBody>> createKey(@Path("key-name") String keyName,
...
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient importKey" })
//        @PUT("keys/{key-name}")
//        Observable<Response<ResponseBody>> importKey(@Path("key-name") String keyName,
//                @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage,
//                @Body KeyImportParameters parameters, @Header("x-ms-parameterized-host") String parameterizedHost,
//                @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient deleteKey" })
//        @HTTP(path = "keys/{key-name}", method = "DELETE", hasBody = true)
//        Observable<Response<ResponseBody>> deleteKey(@Path("key-name") String keyName,
//                @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient updateKey" })
//        @PATCH("keys/{key-name}/{key-version}")
//        Observable<Response<ResponseBody>> updateKey(@Path("key-name") String keyName,
//                @Path("key-version") String keyVersion, @Query("api-version") String apiVersion,
//                @Header("accept-language") String acceptLanguage, @Body KeyUpdateParameters parameters,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient getKey" })
//        @GET("keys/{key-name}/{key-version}")
//        Observable<Response<ResponseBody>> getKey(@Path("key-name") String keyName,
//                @Path("key-version") String keyVersion, @Query("api-version") String apiVersion,
//                @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient getKeyVersions" })
//        @GET("keys/{key-name}/versions")
//        Observable<Response<ResponseBody>> getKeyVersions(@Path("key-name") String keyName,
//                @Query("maxresults") Integer maxresults, @Query("api-version") String apiVersion,
//                @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
...
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient backupKey" })
//        @POST("keys/{key-name}/backup")
//        Observable<Response<ResponseBody>> backupKey(@Path("key-name") String keyName,
//                @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient restoreKey" })
//        @POST("keys/restore")
//        Observable<Response<ResponseBody>> restoreKey(@Query("api-version") String apiVersion,
//                @Header("accept-language") String acceptLanguage, @Body KeyRestoreParameters parameters,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient encrypt" })
//        @POST("keys/{key-name}/{key-version}/encrypt")
//        Observable<Response<ResponseBody>> encrypt(@Path("key-name") String keyName,
//                @Path("key-version") String keyVersion, @Query("api-version") String apiVersion,
//                @Header("accept-language") String acceptLanguage, @Body KeyOperationsParameters parameters,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient decrypt" })
//        @POST("keys/{key-name}/{key-version}/decrypt")
//        Observable<Response<ResponseBody>> decrypt(@Path("key-name") String keyName,
//                @Path("key-version") String keyVersion, @Query("api-version") String apiVersion,
//                @Header("accept-language") String acceptLanguage, @Body KeyOperationsParameters parameters,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient sign" })
//        @POST("keys/{key-name}/{key-version}/sign")
//        Observable<Response<ResponseBody>> sign(@Path("key-name") String keyName,
//                @Path("key-version") String keyVersion, @Query("api-version") String apiVersion,
//                @Header("accept-language") String acceptLanguage, @Body KeySignParameters parameters,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient verify" })
//        @POST("keys/{key-name}/{key-version}/verify")
//        Observable<Response<ResponseBody>> verify(@Path("key-name") String keyName,
//                @Path("key-version") String keyVersion, @Query("api-version") String apiVersion,
//                @Header("accept-language") String acceptLanguage, @Body KeyVerifyParameters parameters,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient wrapKey" })
//        @POST("keys/{key-name}/{key-version}/wrapkey")
//        Observable<Response<ResponseBody>> wrapKey(@Path("key-name") String keyName,
//                @Path("key-version") String keyVersion, @Query("api-version") String apiVersion,
//                @Header("accept-language") String acceptLanguage, @Body KeyOperationsParameters parameters,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient unwrapKey" })
//        @POST("keys/{key-name}/{key-version}/unwrapkey")
//        Observable<Response<ResponseBody>> unwrapKey(@Path("key-name") String keyName,
//                @Path("key-version") String keyVersion, @Query("api-version") String apiVersion,
//                @Header("accept-language") String acceptLanguage, @Body KeyOperationsParameters parameters,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient setSecret" })
//        @PUT("secrets/{secret-name}")
//        Observable<Response<ResponseBody>> setSecret(@Path("secret-name") String secretName,
//                @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage,
//                @Body SecretSetParameters parameters, @Header("x-ms-parameterized-host") String parameterizedHost,
//                @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient deleteSecret" })
//        @HTTP(path = "secrets/{secret-name}", method = "DELETE", hasBody = true)
//        Observable<Response<ResponseBody>> deleteSecret(@Path("secret-name") String secretName,
//                @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
...
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient getSecret" })
//        @GET("secrets/{secret-name}/{secret-version}")
//        Observable<Response<ResponseBody>> getSecret(@Path("secret-name") String secretName,
//                @Path("secret-version") String secretVersion, @Query("api-version") String apiVersion,
//                @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient getSecrets" })
//        @GET("secrets")
//        Observable<Response<ResponseBody>> getSecrets(@Query("maxresults") Integer maxresults,
//                @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient getSecretVersions" })
//        @GET("secrets/{secret-name}/versions")
//        Observable<Response<ResponseBody>> getSecretVersions(@Path("secret-name") String secretName,
//                @Query("maxresults") Integer maxresults, @Query("api-version") String apiVersion,
//                @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient getCertificates" })
//        @GET("certificates")
//        Observable<Response<ResponseBody>> getCertificates(@Query("maxresults") Integer maxresults,
//                @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient deleteCertificate" })
//        @HTTP(path = "certificates/{certificate-name}", method = "DELETE", hasBody = true)
//        Observable<Response<ResponseBody>> deleteCertificate(@Path("certificate-name") String certificateName,
//                @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient setCertificateContacts" })
//        @PUT("certificates/contacts")
//        Observable<Response<ResponseBody>> setCertificateContacts(@Body Contacts contacts,
//                @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient getCertificateContacts" })
//        @GET("certificates/contacts")
//        Observable<Response<ResponseBody>> getCertificateContacts(@Query("api-version") String apiVersion,
//                @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient deleteCertificateContacts" })
//        @HTTP(path = "certificates/contacts", method = "DELETE", hasBody = true)
//        Observable<Response<ResponseBody>> deleteCertificateContacts(@Query("api-version") String apiVersion,
//                @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient getCertificateIssuers" })
//        @GET("certificates/issuers")
//        Observable<Response<ResponseBody>> getCertificateIssuers(@Query("maxresults") Integer maxresults,
//                @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient setCertificateIssuer" })
//        @PUT("certificates/issuers/{issuer-name}")
//        Observable<Response<ResponseBody>> setCertificateIssuer(@Path("issuer-name") String issuerName,
//                @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage,
//                @Body CertificateIssuerSetParameters parameter,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient updateCertificateIssuer" })
//        @PATCH("certificates/issuers/{issuer-name}")
//        Observable<Response<ResponseBody>> updateCertificateIssuer(@Path("issuer-name") String issuerName,
//                @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage,
//                @Body CertificateIssuerUpdateParameters parameter,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient getCertificateIssuer" })
//        @GET("certificates/issuers/{issuer-name}")
//        Observable<Response<ResponseBody>> getCertificateIssuer(@Path("issuer-name") String issuerName,
//                @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient deleteCertificateIssuer" })
//        @HTTP(path = "certificates/issuers/{issuer-name}", method = "DELETE", hasBody = true)
//        Observable<Response<ResponseBody>> deleteCertificateIssuer(@Path("issuer-name") String issuerName,
//                @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient createCertificate" })
//        @POST("certificates/{certificate-name}/create")
//        Observable<Response<ResponseBody>> createCertificate(@Path("certificate-name") String certificateName,
//                @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage,
//                @Body CertificateCreateParameters parameters,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient importCertificate" })
//        @POST("certificates/{certificate-name}/import")
//        Observable<Response<ResponseBody>> importCertificate(@Path("certificate-name") String certificateName,
//                @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage,
//                @Body CertificateImportParameters parameters,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient getCertificateVersions" })
//        @GET("certificates/{certificate-name}/versions")
//        Observable<Response<ResponseBody>> getCertificateVersions(@Path("certificate-name") String certificateName,
//                @Query("maxresults") Integer maxresults, @Query("api-version") String apiVersion,
//                @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient getCertificatePolicy" })
//        @GET("certificates/{certificate-name}/policy")
//        Observable<Response<ResponseBody>> getCertificatePolicy(@Path("certificate-name") String certificateName,
//                @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient updateCertificatePolicy" })
//        @PATCH("certificates/{certificate-name}/policy")
//        Observable<Response<ResponseBody>> updateCertificatePolicy(@Path("certificate-name") String certificateName,
//                @Body CertificatePolicy certificatePolicy, @Query("api-version") String apiVersion,
//                @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient updateCertificate" })
//        @PATCH("certificates/{certificate-name}/{certificate-version}")
//        Observable<Response<ResponseBody>> updateCertificate(@Path("certificate-name") String certificateName,
//                @Path("certificate-version") String certificateVersion, @Query("api-version") String apiVersion,
//                @Header("accept-language") String acceptLanguage, @Body CertificateUpdateParameters parameters,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient getCertificate" })
//        @GET("certificates/{certificate-name}/{certificate-version}")
//        Observable<Response<ResponseBody>> getCertificate(@Path("certificate-name") String certificateName,
//                @Path("certificate-version") String certificateVersion, @Query("api-version") String apiVersion,
//                @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient updateCertificateOperation" })
//        @PATCH("certificates/{certificate-name}/pending")
//        Observable<Response<ResponseBody>> updateCertificateOperation(@Path("certificate-name") String certificateName,
//                @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage,
//                @Body CertificateOperationUpdateParameter certificateOperation,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient getCertificateOperation" })
//        @GET("certificates/{certificate-name}/pending")
//        Observable<Response<ResponseBody>> getCertificateOperation(@Path("certificate-name") String certificateName,
//                @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient deleteCertificateOperation" })
//        @HTTP(path = "certificates/{certificate-name}/pending", method = "DELETE", hasBody = true)
//        Observable<Response<ResponseBody>> deleteCertificateOperation(@Path("certificate-name") String certificateName,
//                @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient mergeCertificate" })
//        @POST("certificates/{certificate-name}/pending/merge")
//        Observable<Response<ResponseBody>> mergeCertificate(@Path("certificate-name") String certificateName,
//                @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage,
//                @Body CertificateMergeParameters parameters,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient getKeyVersionsNext" })
//        @GET
//        Observable<Response<ResponseBody>> getKeyVersionsNext(@Url String nextUrl,
//                @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient getKeysNext" })
//        @GET
//        Observable<Response<ResponseBody>> getKeysNext(@Url String nextUrl,
//                @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient getSecretsNext" })
//        @GET
//        Observable<Response<ResponseBody>> getSecretsNext(@Url String nextUrl,
//                @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient getSecretVersionsNext" })
//        @GET
//        Observable<Response<ResponseBody>> getSecretVersionsNext(@Url String nextUrl,
//                @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient getCertificatesNext" })
//        @GET
//        Observable<Response<ResponseBody>> getCertificatesNext(@Url String nextUrl,
//                @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient getCertificateIssuersNext" })
//        @GET
//        Observable<Response<ResponseBody>> getCertificateIssuersNext(@Url String nextUrl,
//                @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient getCertificateVersionsNext" })
//        @GET
//        Observable<Response<ResponseBody>> getCertificateVersionsNext(@Url String nextUrl,
//                @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
//
//        @Headers({ "Content-Type: application/json; charset=utf-8", "Accept: application/pkcs10",
//                "x-ms-logging-context: com.microsoft.azure.keyvault.KeyVaultClient getPendingCertificateSigningRequest" })
//        @GET("certificates/{certificate-name}/pending")
//        Observable<Response<ResponseBody>> getPendingCertificateSigningRequest(
//                @Path("certificate-name") String certificateName, @Query("api-version") String apiVersion,
//                @Header("accept-language") String acceptLanguage,
//                @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
//
//    }
...
//        return importKey(importKeyRequest.vaultBaseUrl(), importKeyRequest.keyName(), importKeyRequest.key(),
//                importKeyRequest.isHsm(), importKeyRequest.keyAttributes(), importKeyRequest.tags());
//    }
//
//    /**
//     * Imports an externally created key, stores it, and returns key parameters and
...
//            final ServiceCallback<KeyBundle> serviceCallback) {
//        return updateKeyAsync(updateKeyRequest.vaultBaseUrl(), updateKeyRequest.keyName(),
//                updateKeyRequest.keyVersion(), updateKeyRequest.keyOperations(), updateKeyRequest.keyAttributes(),
//                updateKeyRequest.tags(), serviceCallback);
//    }
//
//    /**
...
//     * @return the {@link ServiceFuture} object
//     */
//    public ServiceFuture<KeyBundle> getKeyAsync(String keyIdentifier,
//            final ServiceCallback<KeyBundle> serviceCallback) {
//        KeyIdentifier id = new KeyIdentifier(keyIdentifier);
...
//     * @return the {@link ServiceFuture} object
//     */
//    public ServiceFuture<KeyBundle> getKeyAsync(String vaultBaseUrl, String keyName,
//            final ServiceCallback<KeyBundle> serviceCallback) {
...
//     * @return the {@link ServiceFuture} object
//     */
//    public ServiceFuture<List<KeyItem>> listKeyVersionsAsync(final String vaultBaseUrl, final String keyName,
...
//     */
//    public ServiceFuture<List<KeyItem>> listKeyVersionsAsync(final String vaultBaseUrl, final String keyName,
//            final Integer maxresults, final ListOperationCallback<KeyItem> serviceCallback) {
...
//     * @return the {@link ServiceFuture} object
//     */
//    public ServiceFuture<List<KeyItem>> listKeysAsync(final String vaultBaseUrl,
//            final ListOperationCallback<KeyItem> serviceCallback) {
...
//     * @return the {@link ServiceFuture} object
//     */
//    public ServiceFuture<List<KeyItem>> listKeysAsync(final String vaultBaseUrl, final Integer maxresults,
//            final ListOperationCallback<KeyItem> serviceCallback) {
...
//     */
//    public KeyVerifyResult verify(String keyIdentifier, JsonWebKeySignatureAlgorithm algorithm, byte[] digest,
//            byte[] signature) {
//        KeyIdentifier id = new KeyIdentifier(keyIdentifier);
...
//     * @return the {@link ServiceFuture} object
//     */
//    public ServiceFuture<KeyVerifyResult> verifyAsync(String keyIdentifier, JsonWebKeySignatureAlgorithm algorithm,
//            byte[] digest, byte[] signature, final ServiceCallback<KeyVerifyResult> serviceCallback) {
//        KeyIdentifier id = new KeyIdentifier(keyIdentifier);
//        return verifyAsync(id.vault(), id.name(), id.version() == null ? "" : id.version(), algorithm, digest,
//                signature, serviceCallback);
//    }
//
//    /**
...
//     *            the grouped properties for updating a secret request
//     * @return the SecretBundle if successful.
//     */
...
//                updateSecretRequest.secretAttributes(), updateSecretRequest.tags());
//    }
//
//    /**
//     * Updates the attributes associated with a specified secret in a given key
...
//     * @return the {@link ServiceFuture} object
//     */
//    public ServiceFuture<SecretBundle> updateSecretAsync(UpdateSecretRequest updateSecretRequest,
//            final ServiceCallback<SecretBundle> serviceCallback) {
//        return updateSecretAsync(updateSecretRequest.vaultBaseUrl(), updateSecretRequest.secretName(),
//                updateSecretRequest.secretVersion(), updateSecretRequest.contentType(),
//                updateSecretRequest.secretAttributes(), updateSecretRequest.tags(), serviceCallback);
//    }
//
//    /**
...
//     * @return the {@link ServiceFuture} object
//     */
//    public ServiceFuture<SecretBundle> getSecretAsync(String vaultBaseUrl, String secretName,
//            final ServiceCallback<SecretBundle> serviceCallback) {
...
//     * @return the {@link ServiceFuture} object
//     */
//    public ServiceFuture<List<SecretItem>> listSecretsAsync(final String vaultBaseUrl,
...
//     * @return the {@link ServiceFuture} object
//     */
//    public ServiceFuture<List<SecretItem>> listSecretsAsync(final String vaultBaseUrl, final Integer maxresults,
//            final ListOperationCallback<SecretItem> serviceCallback) {
...
//     * @return the {@link ServiceFuture} object
//     */
//    public ServiceFuture<List<SecretItem>> listSecretVersionsAsync(final String vaultBaseUrl, final String secretName,
//            final ListOperationCallback<SecretItem> serviceCallback) {
...
//     * @return the {@link ServiceFuture} object
//     */
//    public ServiceFuture<List<CertificateItem>> listCertificatesAsync(final String vaultBaseUrl,
...
//     */
//    public ServiceFuture<List<CertificateItem>> listCertificatesAsync(final String vaultBaseUrl,
//            final Integer maxresults, final ListOperationCallback<CertificateItem> serviceCallback) {
...
//     * @return the {@link ServiceFuture} object
//     */
//    public ServiceFuture<List<CertificateIssuerItem>> listCertificateIssuersAsync(final String vaultBaseUrl,
...
//     *
//     * @param setCertificateIssuerRequest
//     *            the grouped properties for setting a certificate issuer request
...
//        return setCertificateIssuer(setCertificateIssuerRequest.vaultBaseUrl(),
//                setCertificateIssuerRequest.issuerName(), setCertificateIssuerRequest.provider(),
//                setCertificateIssuerRequest.credentials(), setCertificateIssuerRequest.organizationDetails(),
...
//     * @return the {@link ServiceFuture} object
//     */
//    public ServiceFuture<IssuerBundle> setCertificateIssuerAsync(
//            SetCertificateIssuerRequest setCertificateIssuerRequest,
//            final ServiceCallback<IssuerBundle> serviceCallback) {
//        return setCertificateIssuerAsync(setCertificateIssuerRequest.vaultBaseUrl(),
//                setCertificateIssuerRequest.issuerName(), setCertificateIssuerRequest.provider(),
//                setCertificateIssuerRequest.credentials(), setCertificateIssuerRequest.organizationDetails(),
//                setCertificateIssuerRequest.attributes(), serviceCallback);
//    }
//
//    /**
//     * Updates the specified certificate issuer.
//     *
//     * @param updateCertificateIssuerRequest
//     *            the grouped properties for updating a certificate issuer request
//     * @return the IssuerBundle if successful.
//     */
//    public IssuerBundle updateCertificateIssuer(UpdateCertificateIssuerRequest updateCertificateIssuerRequest) {
//        return updateCertificateIssuer(updateCertificateIssuerRequest.vaultBaseUrl(),
//                updateCertificateIssuerRequest.issuerName(), updateCertificateIssuerRequest.provider(),
//                updateCertificateIssuerRequest.credentials(), updateCertificateIssuerRequest.organizationDetails(),
...
//     */
//    public ServiceFuture<IssuerBundle> updateCertificateIssuerAsync(
//            UpdateCertificateIssuerRequest updateCertificateIssuerRequest,
//            final ServiceCallback<IssuerBundle> serviceCallback) {
//        return updateCertificateIssuerAsync(updateCertificateIssuerRequest.vaultBaseUrl(),
//                updateCertificateIssuerRequest.issuerName(), updateCertificateIssuerRequest.provider(),
//                updateCertificateIssuerRequest.credentials(), updateCertificateIssuerRequest.organizationDetails(),
//                updateCertificateIssuerRequest.attributes(), serviceCallback);
//    }
//
//    /**
...
//     *            the grouped properties for creating a certificate request
...
//     *            the grouped properties for importing a certificate request
...
//        return importCertificate(importCertificateRequest.vaultBaseUrl(), importCertificateRequest.certificateName(),
//                importCertificateRequest.base64EncodedCertificate(), importCertificateRequest.password(),
//                importCertificateRequest.certificatePolicy(), importCertificateRequest.certificateAttributes(),
...
//     * @return the {@link ServiceFuture} object
//     */
//    public ServiceFuture<CertificateBundle> importCertificateAsync(ImportCertificateRequest importCertificateRequest,
//            final ServiceCallback<CertificateBundle> serviceCallback) {
//        return importCertificateAsync(importCertificateRequest.vaultBaseUrl(),
//                importCertificateRequest.certificateName(), importCertificateRequest.base64EncodedCertificate(),
//                importCertificateRequest.password(), importCertificateRequest.certificatePolicy(),
//                importCertificateRequest.certificateAttributes(), importCertificateRequest.tags(), serviceCallback);
//    }
//
//    /**
...
//     */
//    public ServiceFuture<List<CertificateItem>> listCertificateVersionsAsync(final String vaultBaseUrl,
//            final String certificateName, final Integer maxresults,
//            final ListOperationCallback<CertificateItem> serviceCallback) {
...
//     *
//     * @param updateCertificatePolicyRequest
//     *            the grouped properties for updating a certificate policy request
...
//        return updateCertificatePolicy(updateCertificatePolicyRequest.vaultBaseUrl(),
//                updateCertificatePolicyRequest.certificateName(), updateCertificatePolicyRequest.certificatePolicy());
//    }
//
//    /**
//     * Updates the policy for a certificate. Set appropriate members in the
...
//     * @return the {@link ServiceFuture} object
//     */
//    public ServiceFuture<CertificatePolicy> updateCertificatePolicyAsync(
//            UpdateCertificatePolicyRequest updateCertificatePolicyRequest,
//            final ServiceCallback<CertificatePolicy> serviceCallback) {
//        return updateCertificatePolicyAsync(updateCertificatePolicyRequest.vaultBaseUrl(),
//                updateCertificatePolicyRequest.certificateName(), updateCertificatePolicyRequest.certificatePolicy(),
//                serviceCallback);
//    }
//
...
//     * @return the {@link ServiceFuture} object
//     */
//    public ServiceFuture<CertificateBundle> updateCertificateAsync(UpdateCertificateRequest updateCertificateRequest,
//            final ServiceCallback<CertificateBundle> serviceCallback) {
//        return updateCertificateAsync(updateCertificateRequest.vaultBaseUrl(),
//                updateCertificateRequest.certificateName(), updateCertificateRequest.certificateVersion(),
//                updateCertificateRequest.certificatePolicy(), updateCertificateRequest.certificateAttributes(),
//                updateCertificateRequest.tags(), serviceCallback);
//    }
//
//    /**
...
//     * @return the {@link ServiceFuture} object
//     */
//    public ServiceFuture<CertificateBundle> getCertificateAsync(String vaultBaseUrl, String certificateName,
//            final ServiceCallback<CertificateBundle> serviceCallback) {
...
//     *
//     * @param updateCertificateOperationRequest
//     *            the grouped properties for updating a certificate operation
//     *            request
//     * @return the CertificateOperation if successful.
//     */
//    public CertificateOperation updateCertificateOperation(
//            UpdateCertificateOperationRequest updateCertificateOperationRequest) {
//        return updateCertificateOperation(updateCertificateOperationRequest.vaultBaseUrl(),
...
//     * @return the {@link ServiceFuture} object
//     */
//    public ServiceFuture<CertificateOperation> updateCertificateOperationAsync(
//            UpdateCertificateOperationRequest updateCertificateOperationRequest,
//            final ServiceCallback<CertificateOperation> serviceCallback) {
//        return updateCertificateOperationAsync(updateCertificateOperationRequest.vaultBaseUrl(),
//                updateCertificateOperationRequest.certificateName(),
//                updateCertificateOperationRequest.cancellationRequested(), serviceCallback);
//    }
//
//    /**
...
//     * server.
//     *
//     * @param mergeCertificateRequest
//     *            the grouped properties for merging a certificate request
//     * @return the CertificateBundle if successful.
//     */
//    public CertificateBundle mergeCertificate(MergeCertificateRequest mergeCertificateRequest) {
//        return mergeCertificate(mergeCertificateRequest.vaultBaseUrl(), mergeCertificateRequest.certificateName(),
//                mergeCertificateRequest.x509Certificates(), mergeCertificateRequest.certificateAttributes(),
...
//     * @return the {@link ServiceFuture} object
//     */
//    public ServiceFuture<CertificateBundle> mergeCertificateAsync(MergeCertificateRequest mergeCertificateRequest,
//            final ServiceCallback<CertificateBundle> serviceCallback) {
//        return mergeCertificateAsync(mergeCertificateRequest.vaultBaseUrl(), mergeCertificateRequest.certificateName(),
//                mergeCertificateRequest.x509Certificates(), mergeCertificateRequest.certificateAttributes(),
//                mergeCertificateRequest.tags(), serviceCallback);
//    }
//
//    /**
...
//     */
//    private Observable<ServiceResponse<String>> getPendingCertificateSigningRequestWithServiceResponseAsync(
...
//                        try {
//                            ServiceResponse<String> clientResponse = new ServiceResponse<String>(
