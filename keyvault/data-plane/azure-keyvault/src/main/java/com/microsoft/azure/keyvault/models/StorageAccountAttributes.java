 ...
 */
public final class StorageAccountAttributes {
    /**
     ...
     * accounts in the current vault. If it contains 'Purgeable' the storage
     * account can be permanently deleted by a privileged user; otherwise, only
     * the system can purge the storage account, at the end of the retention
